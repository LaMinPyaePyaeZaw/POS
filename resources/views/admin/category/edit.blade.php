            ...
            <div class="card-body">
                <form action="{{ route('categoryUpdate')}}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control  @error('category') is-invalid @enderror" name="category" value="{{old('category',$data->name)}}" id="exampleFormControlInput1" placeholder="Drinks...">
                        @error('category')
