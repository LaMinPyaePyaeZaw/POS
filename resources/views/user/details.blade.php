        ...
        <div class="container py-5">
            <div class="row g-4 mb-5">
                <div class="col-lg-8 offset-2">
                    <a href="{{ route('shopList') }}"><i class="fa-solid fa-arrow-left m-3"></i>Back</a>
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="border rounded">
                                <a href="#">
                                    <img style="height: 350px" src="{{ asset('productImages/' . $product->image) }}" class="img-fluid w-100 rounded-top"
                                        alt="Image">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            ...
                            <div class="d-flex mb-4">
                                ...
                                <span class="ms-2 mb-3">{{ $ratingCheckedCount->count() }} Ratings</span>
                            </div>
                            ...
                            <form action="{{route('addToCart')}}" method="POST">
                                ...
                                <div class="input-group quantity mb-5" style="width: 100px;">
                                    ...
                                    <input name="qty" type="text" class="form-control form-control-sm text-center border-0"
                                        value="1">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Rating Product</h1>
                                                ...
                                                <div class="card card-body mb-2">
                                                    <div class="rating-css">
                                                        <div class="star-icon">
                                                            @if ($userRating)
                                                                @php
                                                                    $userstars = number_format($userRating);
                                                                @endphp
                        ...
                        <form action="{{ route('comment') }}" method="POST">
                            ...
                            <div class="col-lg-12">
                                <div class="border-bottom rounded my-4">
                                    <textarea name="comment" id="" class="form-control border-0 @error('comment') is-invalid @enderror"
                                        cols="30" rows="8" placeholder="Your Review *" spellcheck="false">{{ old('comment') }}</textarea>
                                    @error('comment')
                ...
                @foreach ($productList as $item)
                    ...
                    <div class="border border-primary rounded position-relative vesitable-item">
                        <div class="vesitable-img">
                            ...
                            <img style="height: 230px" src="{{ asset('productImages/' . $item->image) }}"
